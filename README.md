...
NB! The preparation script uses Qt installed using Homebrew. In order to build Qt locally run the preparation script with following parameters: `./prepare_osx_build_environment.sh zlib libzip qt`
